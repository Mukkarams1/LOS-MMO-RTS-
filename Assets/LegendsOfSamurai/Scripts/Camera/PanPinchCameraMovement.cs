...
namespace CameraActions
{
    public class PanPinchCameraMovement : MonoBehaviour
    {
        ...
        public void CheckifAnyObjectIsInTouch()
        {
            if (Input.touchCount >= 1) //&& Input.GetTouch(0).phase == touchPhase)
            {
                ...
                if (Physics.Raycast(ray, out hit, Mathf.Infinity, layer_mask))
                {
                    ...
                    if (hit.collider.name == "63db7dc222aa5cb535d110d7(Clone)" || hit.collider.name == "63db7dc333aa5cb535d110d7(Clone)" || hit.collider.name == "63db7dc555aa5cb535d110d7(Clone)" || hit.collider.name == "63db7dc732aa5cb535d110d7(Clone)" || hit.collider.name == "63db7dc744aa5cb235d110d7(Clone)" || hit.collider.name == "63db7dc744aa5cb321d110d7(Clone)" || hit.collider.name == "63db7dc744aa5cb535d110d7(Clone)" || hit.collider.name == "63db7dc744aa5cb535d140d7(Clone)" || hit.collider.name == "63db7dc744aa5cb535d155d7(Clone)" || hit.collider.name == "63db7dc744aa5cb535d170d7(Clone)" || hit.collider.name == "63db7dc744aa5cb535d177d7(Clone)"
                    || hit.collider.name == "63db7dc744aa5cb535d310d7(Clone)" || hit.collider.name == "63db7dc744aa5cb535d320d7(Clone)" || hit.collider.name == "63db7dc744aa5cb535d410d7(Clone)" || hit.collider.name == "63db7dc744aa5cb535d770d7(Clone)" || hit.collider.name == "63db7dc744aa5cb535d880d7(Clone)" || hit.collider.name == "63db7dc744aa5cb566d110d7(Clone)" || hit.collider.name == "63db7dc744aa5cb5321110d7(Clone)" || hit.collider.name == "63db7dc766aa5cb535d110d7(Clone)"|| hit.collider.name == "63db7dc777aa5cb535d110d7(Clone)")
                    {
                        overobject = true;
                    }

                }
                //Debug.Log("Touch is On" + hit.collider.name);
            }
        ...
        private void Update()
        {
           ...
           // Debug.Log("i am Returning " + overobject + "And intTouch = " + _initTouch);

            if (_initTouch == false && overobject == false)
            {
                GameManager.instance.buildingButtonsPanel.gameObject.SetActive(false);
                Panning();
                Pinching();
            }
            else
